...
**Applies to `genosdb@0.36.3`.** This skill ships in the same commit as the engine. If the version in your `package.json` is newer, read the [CHANGELOG](https://github.com/estebanrfp/gdb/blob/main/CHANGELOG.md) for what changed since.
